...
# Page 73-81 : https://cs.nyu.edu/~yann/talks/lecun-ranzato-icml2013.pdf
...
### ARTICLE
# Begin to explain what is a kernel and what is a convolution
# Ouput size according to input size (in both dimesions) (no channels)
# k
# p or 'valid' or 'same' or 'full-padding'
# s
# d
# biais
# groups
# compared with plot the groups effet on time spent / number of parameters
# Finish with input and ouput channels
# Finish with trainable parameters and their number calculation
# Then speak about batch

### REMAINS TO BE EVALUATED
# How to integrate image input from user ? (kernel part and conv2d part ?)
# If user's image is integrated, what filter
# Reduce the image size ?
# How to display the values on the images ?
# Can the values can be randomly reinitialize by a button ?
# If yes, a button for each part or a global button ?
# transparence incresing proportionnaly to the number of layers ?
# Activation ?

### IDEAL VISUAL MAX SIZE :
#  I  : 6
#  O  : 3
# H&W : 8
#  K  :
